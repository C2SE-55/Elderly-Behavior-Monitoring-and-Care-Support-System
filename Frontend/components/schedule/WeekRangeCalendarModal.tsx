...
const styles = StyleSheet.create({
  ...
  headerClose: { fontSize: 12, fontWeight: "900", color: COLORS.primary },
  summaryRow: { paddingBottom: 10, gap: 2 },
  summaryText: { fontSize: 13, fontWeight: "900", color: COLORS.text },
  weekHint: { fontSize: 11, fontWeight: "800", color: COLORS.sub },
  ...
  monthNavText: { fontSize: 18, fontWeight: "900", color: COLORS.primary, marginTop: -1 },
  ...
  dowText: { width: 40, textAlign: "center", fontSize: 11, fontWeight: "900", color: COLORS.sub },
  grid: { gap: 6 },
  ...
  daySelected: { backgroundColor: "rgba(167,139,250,0.16)", borderColor: "rgba(167,139,250,0.30)" },
  dayEdge: { backgroundColor: COLORS.primary, borderColor: COLORS.primary },
  ...
  clearText: { color: COLORS.primary, fontWeight: "900", fontSize: 14 },
  chooseBtn: { flex: 1, borderRadius: 12, backgroundColor: COLORS.primary, paddingVertical: 12, alignItems: "center" },
